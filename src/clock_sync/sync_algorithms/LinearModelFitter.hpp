...
#ifndef MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_LINEARMODELFITTER_HPP_
#define MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_LINEARMODELFITTER_HPP_
...
#endif /* MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_LINEARMODELFITTER_HPP_ */
