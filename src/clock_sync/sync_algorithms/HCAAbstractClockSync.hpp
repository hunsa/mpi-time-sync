...
#ifndef MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_HCAABSTRACTCLOCKSYNC_H_
#define MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_HCAABSTRACTCLOCKSYNC_H_
...
#endif /* MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_HCAABSTRACTCLOCKSYNC_H_ */
