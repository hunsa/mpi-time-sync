...
#ifndef MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_LINEARMODELFITTERDEBUG_HPP_
#define MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_LINEARMODELFITTERDEBUG_HPP_
...
#endif /* MPITS_BENCH_SYNC_CLOCK_SYNC_SYNC_METHODS_LINEARMODELFITTERDEBUG_HPP_ */
